          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20">
            ...
            <div>
              ...
              <div className="flex flex-col gap-6">
                <a href="mailto:benjaarncivia@gmail.com" className="flex items-center gap-4 text-zinc-700 dark:text-zinc-300 hover:text-sky-500 transition-colors group w-fit">
                  ...
                  <span className="font-medium">benjaarncivia@gmail.com</span>
                </a>

                <a href="https://github.com/Benja23232" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-zinc-700 dark:text-zinc-300 hover:text-zinc-900 dark:hover:text-white transition-colors group w-fit">
                  ...
                  <span className="font-medium">https://github.com/Benja23232</span>
                </a>
              </div>
            </div>
